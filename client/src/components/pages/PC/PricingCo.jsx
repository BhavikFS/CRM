            ...
            )}
            {
                ...
                <Card className="credit-card mb-4">
                  ...
                  <div className="credit-card-body row">
                    ...
                    <div className={` ${status === 'approved' || status === 'rejected'  ? 'col-lg-5': 'col-md-12 col-lg-4 col-sm-12'}`}>
                      ...
                      >
                        <button className="btnreason mx-1 d-flex justify-content-between">
                          Reason{" "}
                    ...
                    <div className={`${status === 'approved' || status === 'rejected'  ? 'd-none' : 'col-md-12 col-lg-1 col-sm-12'} `}>
...
{user?.role != 'CO' && customers?.length > 0 &&
