...
const PricingCo = () => {
  return (
    <Layout>
      <div className="credit-card-container p-3 pricingCO">
        <Card className="credit-card">
          ...
          <div className="credit-card-body row">
            <div className="credit-card-details col-md-5 col-lg-5 col-sm-12">
              <Row>
            ...
            <div className="credit-card-actions col-md-2 col-lg-2 col-sm-12">
